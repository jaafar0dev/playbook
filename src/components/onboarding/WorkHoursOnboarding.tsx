...
interface WorkHoursOnboardingProps {
  onComplete: (workHours: { startTime: string; endTime: string }) => void;
}
...
export default function WorkHoursOnboarding({ onComplete }: WorkHoursOnboardingProps) {
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <Card className="w-full max-w-lg">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            This helps us schedule tasks that fit your availability
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="p-4 bg-blue-50 rounded-lg">
            <p className="text-sm text-blue-700 text-center">
              You'll work <strong>{startTime}</strong> to <strong>{endTime}</strong>
            </p>
          </div>
